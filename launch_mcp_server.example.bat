...
set "EMBEDDING_MODEL=Xenova/bge-small-en-v1.5"
...
call :log "Starting Windows code search MCP"

call :log "Log directory: %MCP_LOG_DIR%"

call :log "Log retention count: %MCP_LOG_KEEP_COUNT%"
call :log "Transport: streamable-http"
call :log "HTTP stateless mode: %FASTMCP_STATELESS_HTTP%"
call :log "Windows UIA watchdog: %WINDOWS_MCP_WATCHDOG_ENABLED%"
...
set "FASTMCP_STATELESS_HTTP=%FASTMCP_STATELESS_HTTP%"
set "WINDOWS_MCP_WATCHDOG_ENABLED=%WINDOWS_MCP_WATCHDOG_ENABLED%"
