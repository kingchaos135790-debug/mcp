...
namespace MyProject
{
    public static partial class SIMDMath
    {
        ...
        public static void AllSub(this Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            ...
            // s_v3Ops.Subtract(left, right);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void AllSub(this Span<Vector3> left, Vector3 value)
        {
            // In a real implementation, this would call a dispatcher like:
            // s_v3Ops.Subtract(left, value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void SubtractVector3Avx2Entry(Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            ...
            fixed (Vector3* pRight = right)
            {
                ...
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Avx.Subtract(leftX, rightX);
                    var resultY = Avx.Subtract(leftY, rightY);
                    var resultZ = Avx.Subtract(leftZ, rightZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void SubtractVector3Avx2ConstEntry(Span<Vector3> left, Vector3 value)
        {
            const int vectorsPerLoop = 8;
            int len = left.Length;
#if DEBUG
            ...
            fixed (Vector3* pLeft = left)
            {
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Avx.Subtract(leftX, valX);
                    var resultY = Avx.Subtract(leftY, valY);
                    var resultZ = Avx.Subtract(leftZ, valZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void SubtractVector3Sse41Entry(Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            ...
            fixed (Vector3* pRight = right)
            {
                ...
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Sse.Subtract(leftX, rightX);
                    var resultY = Sse.Subtract(leftY, rightY);
                    var resultZ = Sse.Subtract(leftZ, rightZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void SubtractVector3Sse41ConstEntry(Span<Vector3> left, Vector3 value)
        {
            const int vectorsPerLoop = 4;
            int len = left.Length;
#if DEBUG
            ...
            fixed (Vector3* pLeft = left)
            {
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Sse.Subtract(leftX, valX);
                    var resultY = Sse.Subtract(leftY, valY);
                    var resultZ = Sse.Subtract(leftZ, valZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void SubtractVector3ScalarEntry(Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void SubtractVector3ScalarConstEntry(Span<Vector3> left, Vector3 value)
        {
            for (int i = 0; i < left.Length; i++)
            {
                left[i] -= value;
