...
namespace MyProject
{
    public static partial class SIMDMath
    {
        ...
        public static void AllDiv(this Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            ...
            // s_v3Ops.Divide(left, right);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void AllDiv(this Span<Vector3> left, Vector3 value)
        {
            // In a real implementation, this would call a dispatcher like:
            // s_v3Ops.Divide(left, value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void DivideVector3Avx2Entry(Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            ...
            fixed (Vector3* pRight = right)
            {
                ...
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Avx.Divide(leftX, rightX);
                    var resultY = Avx.Divide(leftY, rightY);
                    var resultZ = Avx.Divide(leftZ, rightZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void DivideVector3Avx2ConstEntry(Span<Vector3> left, Vector3 value)
        {
            const int vectorsPerLoop = 8;
            int len = left.Length;
#if DEBUG
            ...
            fixed (Vector3* pLeft = left)
            {
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Avx.Divide(leftX, valX);
                    var resultY = Avx.Divide(leftY, valY);
                    var resultZ = Avx.Divide(leftZ, valZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void DivideVector3Sse41Entry(Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            ...
            fixed (Vector3* pRight = right)
            {
                ...
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Sse.Divide(leftX, rightX);
                    var resultY = Sse.Divide(leftY, rightY);
                    var resultZ = Sse.Divide(leftZ, rightZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void DivideVector3Sse41ConstEntry(Span<Vector3> left, Vector3 value)
        {
            const int vectorsPerLoop = 4;
            int len = left.Length;
#if DEBUG
            ...
            fixed (Vector3* pLeft = left)
            {
                for (int i = 0; i < len; i += vectorsPerLoop)
                {
                    ...
                    var resultX = Sse.Divide(leftX, valX);
                    var resultY = Sse.Divide(leftY, valY);
                    var resultZ = Sse.Divide(leftZ, valZ);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void DivideVector3ScalarEntry(Span<Vector3> left, ReadOnlySpan<Vector3> right)
        {
            for (int i = 0; i < left.Length; i++)
            {
                left[i] = Vector3.Divide(left[i], right[i]);
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void DivideVector3ScalarConstEntry(Span<Vector3> left, Vector3 value)
        {
            for (int i = 0; i < left.Length; i++)
            {
                left[i] = Vector3.Divide(left[i], value);
            }
        }
    }
}